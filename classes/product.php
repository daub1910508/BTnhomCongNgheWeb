	...
	class product
	{
		...
		public function insert_product($data,$files){
			...
			if($productName=="" || $brand=="" || $category=="" || $product_desc=="" || $price=="" || $type=="" || $file_name ==""){
				...
				if($result){
					...
					$alert = "<span class='error'>Chèn sản phẩm không thành công</span>";
					return $alert;
				}
			}
		}
		public function insert_slider($data,$files){
			...
			if($sliderName=="" || $type==""){
				...
				if(!empty($file_name)){
					...
					if ($file_size > 6048000) {

		    		 $alert = "<span class='success'>Kích thước hình ảnh phải nhỏ hơn 4MB!</span>";
					return $alert;
				    } 
		...
		public function del_slider($id){
			...
			if($result){
				...
				$alert = "<span class='error'>Đã xóa thanh trượt không thành công</span>";
				return $alert;
			}
		}
		...
		public function del_product($id){
			...
			$result = $this->db->delete($query);
			if($result){
				$alert = "<span class='success'>Sản phẩm bị xóa  thành công</span>";
				return $alert;
			}else{

        ...
        <div class="section group">
            ...
            <div class="listview_1_of_2 images_1_of_2">
                ...
                <div class="text list_2_of_1">
                    ...
                    <div class="button"><span><a href="details.php?proid=<?php echo $resultdell['productId']  ?>">Thêm
            ...
            <div class="listview_1_of_2 images_1_of_2">
                ...
                <div class="text list_2_of_1">
                    ...
                    <div class="button"><span><a href="details.php?proid=<?php echo $resultss['productId']  ?>">Thêm vào
                                giỏ hàng</a></span></div>
                </div>
            </div>
            <?php
        ...
        <div class="section group">
            ...
            <div class="listview_1_of_2 images_1_of_2">
                ...
                <div class="text list_2_of_1">
                    ...
                    <div class="button"><span><a href="details.php?proid=<?php echo $resultap['productId']  ?>">Thêm vào
                                giỏ hàng</a></span></div>
                </div>
            </div>
            <?php
            ...
            <div class="listview_1_of_2 images_1_of_2">
                ...
                <div class="text list_2_of_1">
                    ...
                    <div class="button"><span><a href="details.php?proid=<?php echo $resulthw['productId']  ?>">Thêm vào
                                giỏ hàng</a></span></div>
                </div>
            </div>
            <?php
